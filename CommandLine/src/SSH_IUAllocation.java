...
public class SSH_IUAllocation extends SSH {
	...
	public static String buildCommandOARSUB(int nbNoeuds, int tpsAllocation) throws Exception {
	...
	public static void allocateNodes(String command) throws IOException {
		
		out.write(command.getBytes());
		out.write("\n".getBytes());
		out.flush();
		
		out.write("cat $OAR_NODE_FILE | uniq -c".getBytes());
		out.write("\n".getBytes());
		out.flush();
